...
def proof_of_work(block):
    ...
    proof = 0 # proof
    while valid_proof(block_string, proof) is False: # checks to see if valid_proof is True
...
def valid_proof(block_string, proof):
    ...
    return guess_hash[:6] == '000000' # sees if theres 3 LEADING zeroes in the hash. It returns TRUE in the proof_of_work
